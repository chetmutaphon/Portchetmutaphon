...
3. สร้าง folder ข้างใน bucket `portfolio`:
   ...
   - **`socialmedia`** — รูป Social Media / Marketing
...
5. Bucket **`portfolio`** → folder **`socialmedia`** — รูป Social Media
...
- Section **Marketing (Social)** ดึงจาก `portfolio/socialmedia/`
...
- การเปลี่ยนแปลงเซฟใน `localStorage` ของ browser — กด **บันทึก** ใน toolbar ก่อน logout
