...
├── artwork/            ← folder รูป Design Work
│   └── AW1.jpg
└── photography/        ← folder รูป Photography
    └── Photo1.jpg
```
...
1. Bucket **`portfolio`** → folder **`artwork`** — ใส่รูป Design Work
2. Bucket **`portfolio`** → folder **`photography`** — ใส่รูป Photography
